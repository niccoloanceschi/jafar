...
```{r}
reordered_X <- reorder_features(Data$X_m,X_m_test=Data$X_m_test)
X_m <- reordered_X$X_m
...
The prior entails additional hyperparameters, detailed in the documentation of the function $\texttt{set_hyperparameters}$.
...
Built-in functions allow to visualize mean predicted values and $90\%$ credible intervals against the truth.
