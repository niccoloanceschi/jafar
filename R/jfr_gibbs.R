...
#' Gibbs Sampler for JFR
#'
#' @description
#' Fits a Joint Factor Regression (JFR) model using Gibbs sampling.
#' The model can be fitted in both unsupervised (no response) and supervised (with response y) settings. 
...
#'  \itemize{
#'    \item{\code{K}}{Number latent factors (vector of length \code{tEff}).}
