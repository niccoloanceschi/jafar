...
#' Out-of-sample prediction for \code{bsfp}
#'
#' @description Modified version of the function \code{bsfp.predict} from the GitHub repo \code{bsfp} for out-of-sample predictions.
...
#' @export
#' 
predict.bsfp.oos <- function(bsfp.fit, test_data, response_type='continuous', model_params = NULL, nsample, progress = TRUE, starting_values = NULL) {
